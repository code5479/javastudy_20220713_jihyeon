...
public class StudentArrayList {
	...
	public static void main(String[] args) {
		...
		/*
		 * studentList(변수명) 학생들 전부 add시키기 Student 배열을 생성하고 그 배열을 리스트로 변환 후 새로운
		 * ArrayList를 생성하여 전체를 추가
		 */
...
//		for(int i = 0; i < students.length; i++) {			바로 위 asList랑 같은 방법
