...
public class StringList {
	...
	public static void main(String[] args) {
		...
		// 값 삭제
		list.remove("python");
		System.out.println(list);		//첫번째 python 지움
		list.remove(5);
		System.out.println(list);
		list.removeAll(tempList);
		System.out.println(list);
		
		//해당 컬렉션을 포함한느 것을 제외하고 다 지움
		...
		List<String> asList = Arrays.asList(new String[] {"java", "python", "c++", "html"}); //인터페이스 리스트임, 배열에 값 바로 추가 가능
