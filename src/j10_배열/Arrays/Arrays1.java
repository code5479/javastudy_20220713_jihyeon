...
public class Arrays1 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 1.배열의 내용을 검색 후 인덱스를 반환하는 방법 -binarySearch(찾고자 하는 값)
		 * 
		 * 2.배열을 복사할 때 사용하는 메소드 -copyOf(복사하고자 하는 배열, 새로 생성할 배열의 크기)
		 * 
		 * 3.배열을 복사할 때 원하는 범위만 복사해주는 메소드 -copyOfRange(복사하고자 하는 배열, 시작 인덱스, 마지막 인덱스)
		 * 
		 * 3.배열을 초기화 하고 원하는 값으로 모두 채우는 메소드 -fill(초기화 하고자 하는 배열, 채울값)
		 * 
		...
		System.out.println("찾은 인덱스: " + index); // 정렬을 한 상태에서 binarySesrch 해줘야함
